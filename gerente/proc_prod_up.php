...
while ($dados = $consultar->fetch_assoc()) {
    ...
    <br>
    <form action='atualizar_prod_up.php?id=$id' method='POST'>
    <div class='form-row'>
    ...
    <div class='form-row'>
        ...
        <div class='form-group col-md-3'>
            <label>Preço R$</label>
            <input type='text' id='money' value='$preco' class='form-control' name='preco'>
        </div>
        <div class='form-group col-md-3'>
        ...
        <div class='form-group col-md-3'>
            <label>Qtd p/ somar</label>
            <input type='text' name='qSoma' class='form-control'>
        </div>
    </div>
    <div class='form-row'>
        <div class='form-group col-md-3'>
            <button type='submit' class='form-control btn bg-info' style='color:white;'>Atualizar</button>
        </div>
    </div>
    </form>
</div>
