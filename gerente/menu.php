    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="menu.php?p=form_user.php">Cadastrar Funcionário</a>
                </li>
                <li>
                    <a href="menu.php?p=form_fornecedor.php">Cadastrar Fornecedor</a>
                </li>
                <li>
                ...
                <li>
                    <a href="menu.php?p=ver_fornecedor.php">Pesquisar Fornecedor</a>
                </li>
                <li>
                ...
                <li class="active">
                    ...
                    <ul class="collapse list-unstyled" id="homeSubmenu">
                        ...
                        <li>
                            <a href="#">Pedir produto</a>
                        </li>
                        <li>
                            <a href="#">Posição no Estoque</a>
                        </li>
                        <li>
                            <a href="#">Lista de sessões abertas e fechadas</a>
                        </li>
                        <li>
                            <a href="#">Operações realizadas</a>
                        </li>
                    </ul>
                </li>
                <li>
